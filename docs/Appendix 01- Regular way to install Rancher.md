...
![exercise1-task1-1-create-resource-group-Rancher](docs/images/exercise1-task1-1-create-resource-group-Rancher.png)
...
![rancher-firsttime-setup-page](docs/images/rancher-firsttime-setup-page.png)
...
![rancher-setup-password](docs/images/rancher-setup-password.png)

You can then land on the **Home** page of Rancher Server.

![rancher-homepage](docs/images/rancher-homepage.png)
